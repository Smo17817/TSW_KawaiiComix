		...
		<section id="new_article">
			<form action="AddNewsServlet" method="POST">
				<div class="form-wrapper">
					...
					<div class="form-row">
						<label for="titolo">Titolo: </label> <input type="text" name="titolo"
					...
					<div class="form-row">
						<label for="video">Video: </label> <input type="text"
							name="video"
							placeholder="./video/nome_img.formato OPPURE youtube_link">
					</div>
					<div class="form-row">
						<label for="corpo">Corpo </label> <input type="text"
							name="corpo" placeholder="Scrivi qui il tuo articolo" required>
					</div>
					<div class= "sub-class">
